                            ...
                            <tbody>
                                @foreach ($catatan as $history)
                                    <tr>
                                        ...
                                        <td>   
                                            <form action="{{ route('history.destroy', $history->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger">Delete</button>
                                            <button type="button" class="btn btn-float" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="onEdit(this, {{ $history->id }})">
                                                Edit
                                            </button>
                                        </td>
                                        </tr>
