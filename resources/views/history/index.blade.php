...
<head>
    ...
    <style>
        ...
        .table {
            ...
            /* Gunakan separate untuk border-radius bekerja dengan baik */
            border-spacing: 1;
        ...
        .text-logo {
            font-size: 18px;
            /* Ukuran font teks logo */
            font-weight: bold;
            /* Berat font teks logo */
            color: #ffffff;
            /* Warna teks logo */
        }
        ...
        .dropdown-content {
            ...
            position: absolute;
            top: 100%;
            /* Pastikan dropdown berada di bawah form field */
            left: 0;
            background-color: #ffffff;
            width: 100%;
            /* Memastikan dropdown sesuai dengan lebar input field */
            box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.1);
            border-radius: 0 0 8px 8px;
            z-index: 1;
            max-height: 200px;
            overflow-y: auto;
            border-top: 2px solid #bd2130;
            /* Warna border sesuai dengan yang diinginkan */
        }
        ...
        .justify-content-start {
            ...
            /* Memposisikan elemen di awal baris */
        }
...
<body>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#edit{{ $history->id }}">Edit</button>
    ...
    <script></script> <!--end::OverlayScrollbars Configure--> <!-- OPTIONAL SCRIPTS --> <!-- sortablejs -->
                ...
                @foreach ($catatan as $history)
                    ...
                    if (pengajuanTanggal{{ $history->id }}) {
                        ...
                        if (isNaN(pengajuanDate{{ $history->id }}.getTime())) {
                            ...
                            const formattedDueDate{{ $history->id }} = dueDate{{ $history->id }}.toLocaleDateString(
                                'id-ID', options);
...
">
        <strong>Copyright &copy; 2024 <a href="/sesi"
                style="color: rgb(85, 109, 218); text-decoration: none;">SIMedia</a>.</strong>
        All rights reserved.
